		...
		<div class="row mainRow">
			<div class="col-xs-2 leftMenuBar">
				<ul class="leftNav">
					...
					<li class="activeMenuLine"><a class="activeMenuItem" href="approvedVerifications.php"><span><i class="fa fa-check" aria-hidden="true"></i></span>APPROVED VERIFICATIONS</a></li>
			...
			<div class="col-xs-10 rightContent">
				...
				<?php
						...
						if($approvedVerifications && mysqli_num_rows($approvedVerifications)){
							...
							echo "<p id='noPendingVerificationsNotice'>You have no approved verifications.</p>";
						}
					?>
			</div>
		</div>
